...
/*
Resource is the resource aws_appflow_flow.
...
func (aaf awsAppflowFlowAttributes) DestinationFlowConfig() terra.SetValue[destinationFlowConfigAttributes] {
	return terra.ReferenceAsSet[destinationFlowConfigAttributes](aaf.ref.Append("destination_flow_config"))
}
