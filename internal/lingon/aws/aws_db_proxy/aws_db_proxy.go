...
/*
Resource is the resource aws_db_proxy.
...
func (adp awsDbProxyAttributes) Auth() terra.ListValue[authAttributes] {
	return terra.ReferenceAsList[authAttributes](adp.ref.Append("auth"))
}
