...
/*
Resource is the resource aws_pipes_pipe.
...
type Args struct {
	...
	// SourceParameters is required.
	SourceParameters *SourceParameters `hcl:"source_parameters,block" validate:"required"`
	// TargetParameters is required.
	TargetParameters *TargetParameters `hcl:"target_parameters,block" validate:"required"`
