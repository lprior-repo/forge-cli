...
/*
DataSource is the data source aws_alb_target_group.
...
func (aatg dataAwsAlbTargetGroupAttributes) DeregistrationDelay() terra.NumberValue {
	return terra.ReferenceAsNumber(aatg.ref.Append("deregistration_delay"))
}
