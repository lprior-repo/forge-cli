...
/*
Resource is the resource aws_apigatewayv2_api.
...
type Args struct {
	// ApiKeySelectionExpression is optional.
	...
	// RouteKey is optional.
	RouteKey terra.StringValue `hcl:"route_key,attr"`
	// RouteSelectionExpression is optional.
