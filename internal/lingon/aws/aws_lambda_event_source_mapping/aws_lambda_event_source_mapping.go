...
/*
Resource is the resource aws_lambda_event_source_mapping.
...
type Args struct {
	...
	// ParallelizationFactor is optional.
	...
	// StartingPositionTimestamp is optional.
	...
	// TumblingWindowInSeconds is optional.
	TumblingWindowInSeconds terra.NumberValue `hcl:"tumbling_window_in_seconds,attr"`
	// AmazonManagedKafkaEventSourceConfig is optional.
...
func (alesm awsLambdaEventSourceMappingAttributes) Queues() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](alesm.ref.Append("queues"))
}
