...
/*
Resource is the resource aws_iam_role.
...
func (air awsIamRoleAttributes) RoleLastUsed() terra.ListValue[roleLastUsedAttributes] {
	return terra.ReferenceAsList[roleLastUsedAttributes](air.ref.Append("role_last_used"))
}
...
type awsIamRoleState struct {
	...
	RoleLastUsed        []RoleLastUsedState `json:"role_last_used"`
