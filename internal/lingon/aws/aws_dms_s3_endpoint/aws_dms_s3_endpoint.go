...
/*
Resource is the resource aws_dms_s3_endpoint.
...
type Args struct {
	...
	// AddTrailingPaddingCharacter is optional.
	...
	// DatePartitionTimezone is optional.
	DatePartitionTimezone terra.StringValue `hcl:"date_partition_timezone,attr"`
	// DetachTargetOnLobLookupFailureParquet is optional.
