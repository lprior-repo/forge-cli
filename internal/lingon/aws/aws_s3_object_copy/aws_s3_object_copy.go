...
/*
Resource is the resource aws_s3_object_copy.
...
type Args struct {
	...
	// CacheControl is optional.
	CacheControl terra.StringValue `hcl:"cache_control,attr"`
	// ContentDisposition is optional.
	...
	// ExpectedSourceBucketOwner is optional.
