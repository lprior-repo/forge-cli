...
/*
Resource is the resource aws_licensemanager_grant.
...
type Args struct {
	// AllowedOperations is required. Allowed operations for the grant. This is a subset of the allowed operations on the license.
	AllowedOperations terra.SetValue[terra.StringValue] `hcl:"allowed_operations,attr" validate:"required"`
	// Id is optional.
	Id terra.StringValue `hcl:"id,attr"`
	// LicenseArn is required. License ARN.
	LicenseArn terra.StringValue `hcl:"license_arn,attr" validate:"required"`
	// Name is required. Name of the grant.
	Name terra.StringValue `hcl:"name,attr" validate:"required"`
	// Principal is required. The grantee principal ARN. The target account for the grant in the form of the ARN for an account principal of the root user.
