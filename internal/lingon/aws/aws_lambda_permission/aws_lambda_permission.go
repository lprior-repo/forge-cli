...
/*
Resource is the resource aws_lambda_permission.
...
type Args struct {
	...
	// FunctionUrlAuthType is optional.
	...
	// StatementId is optional.
	StatementId terra.StringValue `hcl:"statement_id,attr"`
	// StatementIdPrefix is optional.
