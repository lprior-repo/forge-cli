...
/*
Resource is the resource aws_emr_studio.
...
type Args struct {
	...
	// UserRole is optional.
	UserRole terra.StringValue `hcl:"user_role,attr"`
	// VpcId is required.
	VpcId terra.StringValue `hcl:"vpc_id,attr" validate:"required"`
	// WorkspaceSecurityGroupId is required.
