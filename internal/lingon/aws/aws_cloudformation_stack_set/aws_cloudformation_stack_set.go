...
/*
Resource is the resource aws_cloudformation_stack_set.
...
type Args struct {
	// AdministrationRoleArn is optional.
	...
	// AutoDeployment is optional.
	AutoDeployment *AutoDeployment `hcl:"auto_deployment,block"`
	// OperationPreferences is optional.
