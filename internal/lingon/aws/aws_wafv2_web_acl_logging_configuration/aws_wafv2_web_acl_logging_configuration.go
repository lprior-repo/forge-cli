...
/*
Resource is the resource aws_wafv2_web_acl_logging_configuration.
...
type Args struct {
	...
	// LogDestinationConfigs is required. AWS Kinesis Firehose Delivery Stream ARNs
	LogDestinationConfigs terra.SetValue[terra.StringValue] `hcl:"log_destination_configs,attr" validate:"required"`
	// ResourceArn is required. AWS WebACL ARN
	ResourceArn terra.StringValue `hcl:"resource_arn,attr" validate:"required"`
	// LoggingFilter is optional.
	LoggingFilter *LoggingFilter `hcl:"logging_filter,block"`
	// RedactedFields is min=0,max=100. Parts of the request to exclude from logs
