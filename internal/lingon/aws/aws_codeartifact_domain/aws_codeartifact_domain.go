...
/*
Resource is the resource aws_codeartifact_domain.
...
func (acd awsCodeartifactDomainAttributes) AssetSizeBytes() terra.NumberValue {
	return terra.ReferenceAsNumber(acd.ref.Append("asset_size_bytes"))
}
