...
/*
Resource is the resource aws_redshift_cluster.
...
type Args struct {
	// AllowVersionUpgrade is optional.
	...
	// AquaConfigurationStatus is optional.
	AquaConfigurationStatus terra.StringValue `hcl:"aqua_configuration_status,attr"`
	// AutomatedSnapshotRetentionPeriod is optional.
	...
	// AvailabilityZoneRelocationEnabled is optional.
	...
	// EnhancedVpcRouting is optional.
	...
	// MaintenanceTrackName is optional.
	MaintenanceTrackName terra.StringValue `hcl:"maintenance_track_name,attr"`
	// ManualSnapshotRetentionPeriod is optional.
	...
	// SnapshotClusterIdentifier is optional.
