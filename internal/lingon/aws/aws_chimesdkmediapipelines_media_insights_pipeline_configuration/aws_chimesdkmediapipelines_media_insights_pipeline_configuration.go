...
/*
Resource is the resource aws_chimesdkmediapipelines_media_insights_pipeline_configuration.
...
type Args struct {
	...
	// ResourceAccessRoleArn is required.
	...
	// RealTimeAlertConfiguration is optional.
