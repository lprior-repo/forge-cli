...
/*
Resource is the resource aws_globalaccelerator_endpoint_group.
...
type Args struct {
	...
	// ThresholdCount is optional.
	ThresholdCount terra.NumberValue `hcl:"threshold_count,attr"`
	// TrafficDialPercentage is optional.
