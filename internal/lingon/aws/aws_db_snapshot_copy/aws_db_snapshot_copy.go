...
/*
Resource is the resource aws_db_snapshot_copy.
...
type Args struct {
	...
	// PresignedUrl is optional.
	PresignedUrl terra.StringValue `hcl:"presigned_url,attr"`
	// SourceDbSnapshotIdentifier is required.
