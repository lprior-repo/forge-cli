...
/*
Resource is the resource aws_sns_topic_subscription.
...
type Args struct {
	// ConfirmationTimeoutInMinutes is optional.
	...
	// SubscriptionRoleArn is optional.
