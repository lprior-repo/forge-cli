...
/*
Resource is the resource aws_sqs_queue.
...
type Args struct {
	...
	// MaxMessageSize is optional.
	MaxMessageSize terra.NumberValue `hcl:"max_message_size,attr"`
	// MessageRetentionSeconds is optional.
