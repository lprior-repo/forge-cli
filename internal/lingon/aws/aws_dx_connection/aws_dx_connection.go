...
/*
Resource is the resource aws_dx_connection.
...
func (adc awsDxConnectionAttributes) VlanId() terra.StringValue {
	return terra.ReferenceAsString(adc.ref.Append("vlan_id"))
}
