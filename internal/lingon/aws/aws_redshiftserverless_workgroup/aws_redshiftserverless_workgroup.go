...
/*
Resource is the resource aws_redshiftserverless_workgroup.
...
func (arw awsRedshiftserverlessWorkgroupAttributes) ConfigParameter() terra.ListValue[configParameterAttributes] {
	return terra.ReferenceAsList[configParameterAttributes](arw.ref.Append("config_parameter"))
}
