...
/*
Resource is the resource aws_apigatewayv2_authorizer.
...
type Args struct {
	...
	// AuthorizerCredentialsArn is optional.
	AuthorizerCredentialsArn terra.StringValue `hcl:"authorizer_credentials_arn,attr"`
	// AuthorizerPayloadFormatVersion is optional.
