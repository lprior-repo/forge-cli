...
/*
Resource is the resource aws_iam_user.
...
type Args struct {
	// ForceDestroy is optional. Delete user even if it has non-Terraform-managed IAM access keys, login profile or MFA devices
