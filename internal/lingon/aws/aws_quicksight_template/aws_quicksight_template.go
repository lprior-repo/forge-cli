...
/*
Resource is the resource aws_quicksight_template.
...
type Args struct {
	...
	// VersionDescription is required.
...
func (aqt awsQuicksightTemplateAttributes) Permissions() terra.ListValue[permissionsAttributes] {
