...
/*
Resource is the resource aws_dms_replication_subnet_group.
...
func (adrsg awsDmsReplicationSubnetGroupAttributes) Timeouts() timeoutsAttributes {
	return terra.ReferenceAsSingle[timeoutsAttributes](adrsg.ref.Append("timeouts"))
}
